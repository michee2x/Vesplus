...
const Nav = () => {
  ...
  return (
    <div className="fixed hidden lg:px-6 p-6 lg:py-0 z-[9000] flex-col lg:flex-row items-center flex justify-between border-b-[.3px] border-white/[0.2] w-screen min-h-16  bg-inherit/[0.5] backdrop-blur-[20px]">
